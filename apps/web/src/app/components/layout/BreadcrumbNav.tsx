...
const pageHierarchy: Record<Page, { label: string; parent?: Page }> = {
  ...
  'agency-detail': { label: 'Agency Details', parent: 'agencies' },
  'sub-agencies': { label: 'Sub-Agencies', parent: 'agencies' },
  'sub-agency-detail': { label: 'Sub-Agency Details', parent: 'sub-agencies' },
  'tie-ups': { label: 'Tie-Ups & Contracts', parent: 'agencies' },
  'tie-up-detail': { label: 'Tie-Up Details', parent: 'tie-ups' },
  'super-admin': { label: 'Super Admin', parent: 'home' },
