      ...
      <div className="relative z-10 w-full max-w-md px-4">
        ...
        <SignIn
          appearance={{
            ...
            elements: { rootBox: 'mx-auto', card: 'bg-[#0f0f1a] border border-white/10 shadow-2xl rounded-2xl', formButtonPrimary: 'bg-primary hover:bg-accent0', headerTitle: 'hidden', headerSubtitle: 'hidden', socialButtonsBlockButton: 'border-white/20 bg-white/5 hover:bg-white/10', socialButtonsBlockButtonText: 'text-white font-medium', socialButtonsBlockButtonArrow: 'text-white', dividerText: 'text-white/40', dividerLine: 'bg-white/10' },
          }}
        />
      </div>
    </div>
