      ...
      <div className="relative z-10 w-full max-w-md px-4">
        ...
        <SignUp
          appearance={{
            ...
            elements: { rootBox: 'mx-auto', card: 'bg-[#0f0f1a] border border-white/10 shadow-2xl rounded-2xl', formButtonPrimary: 'bg-primary hover:bg-accent0', headerTitle: 'hidden', headerSubtitle: 'hidden' },
          }}
        />
      </div>
    </div>
